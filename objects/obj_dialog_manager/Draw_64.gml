...
if (speaker == "Boy") { draw_sprite(spr_boyFace, 0, 570, 256) };
...
if (dialog_action == "coin-1") {
	global.playerMoney -= 1;
	draw_text(obj_inventory.x, obj_inventory.y, "-1 пай");

}

if (dialog_action == "coin-20") {
	global.playerMoney -= 20;
	draw_text(obj_inventory.x, obj_inventory.y, "-20 пай");

}

if (dialog_action == "coin-30") {
	global.playerMoney -= 30;
	draw_text(obj_inventory.x, obj_inventory.y, "-30 пай");

}

if (dialog_action == "open_hole") {
	global.playerMoney -= 20;//////////// чтото придумать
	draw_text(obj_inventory.x, obj_inventory.y, "-20 пай");
